...
const buildQuery = ({ search, tipoId, empresaId, fechaDesde, fechaHasta, page }) => {
  const q = { estado: 'en_revision_final', page, limit: LIMIT };
...
const BandejaFinal = () => {
  ...
  const emptyDesc  = hasFilters
    ...
    : 'No hay trámites esperando decisión final en este momento.';
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-display-sm text-primary font-semibold">Bandeja de Decisión Final</h1>
        <p className="text-body-md text-on-surface-variant mt-1">
          Trámites con revisiones completas esperando tu decisión
        </p>
      </div>
